          ...
          function r(e) {
            return new Promise(function(t, n) {
              ...
              (r.onupgradeneeded = function() {
                r.result.createObjectStore(h, { keyPath: p }).createIndex(l, l, { unique: !1 });
              }),
        ...
        function(e, t, n) {
          ...
          function r(e) {
            ...
            t
              ...
              : a.default && 'GET' === e.request.method && 0 === e.request.url.indexOf('http') && e.respondWith(a.default(e.request));
          }
          function o(e) {
      ...
      4: [
        function(e, t, n) {
          ...
          (r = self.registration ? self.registration.scope : self.scope || new URL('./', self.location).href),
            (t.exports = {
              cache: { name: '$$$toolbox-cache$$$' + r + '$$$', maxAgeSeconds: null, maxEntries: null, queryOptions: null },
              debug: !1,
          ...
          var r = new URL('./', self.location),
            ...
            c = function(e, t, n, r) {
              t instanceof RegExp
                ...
                : (0 !== t.indexOf('/') && (t = o + t), (this.keys = []), (this.regexp = i(t, this.keys))),
                (this.method = e),
                (this.options = r),
                (this.handler = n);
            };
        ...
        function(e, t, n) {
          ...
          ['get', 'post', 'put', 'delete', 'head', 'any'].forEach(function(e) {
            ...
            (s.prototype.add = function(e, t, n, c) {
              c = c || {};
              var s;
              t instanceof RegExp ? (s = RegExp) : ((s = c.origin || self.location.origin), (s = s instanceof RegExp ? s.source : r(s))),
                (e = e.toLowerCase());
              var a = new o(e, t, n, c);
        ...
        function(e, t, n) {
          !(function() {
            ...
            if (t)
              var n = t[1],
                r = parseInt(t[2]);
            (e && (!t || ('Firefox' === n && r >= 46) || ('Chrome' === n && r >= 50))) ||
